...
5. Now save this command into j.bat and keep this file in the PATH environment variable (say for Windows OS).
...
j x task <id>[,<id>...] <note text>  # Alternative command
```

**Update task due date**:
```
j due task <id> <keyword|YYYY-MM-DD>
```
